...
import net.kilogram.messenger.utils.ZipUtil;
...
//    private final AbstractConfigCell useCustomEmojiRow = cellGroup.appendCell(new ConfigCellTextCheck(NekoConfig.useCustomEmoji));
    ...
    private final AbstractConfigCell customCustomChannelLabelRow = cellGroup.appendCell(new ConfigCellTextInput(null, KiloConfig.INSTANCE.getCustomChannelLabel(),
            null, null,
    ...
    private final AbstractConfigCell fakeHighPerformanceDeviceRow = cellGroup.appendCell(new ConfigCellTextCheck(KiloConfig.INSTANCE.getFakeHighPerformanceDevice()));
    private final AbstractConfigCell disableEmojiDrawLimitRow = cellGroup.appendCell(new ConfigCellTextCheck(KiloConfig.INSTANCE.getDisableEmojiDrawLimit()));
