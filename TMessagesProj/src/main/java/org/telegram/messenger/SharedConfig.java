...
import net.kilogram.messenger.proxy.ProxyManager;
import net.kilogram.messenger.proxy.ShadowsocksLoader;
import net.kilogram.messenger.proxy.ShadowsocksRLoader;
import net.kilogram.messenger.proxy.VmessLoader;
import net.kilogram.messenger.proxy.tcp2ws.WsLoader;
...
//    }
    ...
    public static int getDevicePerformanceClass() {
        ...
        if (KiloConfig.INSTANCE.getFakeHighPerformanceDevice().Bool()) {
            devicePerformanceClass = PERFORMANCE_CLASS_HIGH;
        }
