...
package net.kilogram.messenger.ui.syntaxhighlight;
...
import net.kilogram.messenger.prism4j.GrammarLocator;
import net.kilogram.messenger.prism4j.Prism4j;
import net.kilogram.messenger.prism4j.languages.Prism_brainfuck;
import net.kilogram.messenger.prism4j.languages.Prism_c;
import net.kilogram.messenger.prism4j.languages.Prism_clike;
import net.kilogram.messenger.prism4j.languages.Prism_clojure;
import net.kilogram.messenger.prism4j.languages.Prism_cpp;
import net.kilogram.messenger.prism4j.languages.Prism_csharp;
import net.kilogram.messenger.prism4j.languages.Prism_css;
import net.kilogram.messenger.prism4j.languages.Prism_css_extras;
import net.kilogram.messenger.prism4j.languages.Prism_dart;
import net.kilogram.messenger.prism4j.languages.Prism_git;
import net.kilogram.messenger.prism4j.languages.Prism_go;
import net.kilogram.messenger.prism4j.languages.Prism_groovy;
import net.kilogram.messenger.prism4j.languages.Prism_java;
import net.kilogram.messenger.prism4j.languages.Prism_javascript;
import net.kilogram.messenger.prism4j.languages.Prism_json;
import net.kilogram.messenger.prism4j.languages.Prism_kotlin;
import net.kilogram.messenger.prism4j.languages.Prism_latex;
import net.kilogram.messenger.prism4j.languages.Prism_makefile;
import net.kilogram.messenger.prism4j.languages.Prism_markdown;
import net.kilogram.messenger.prism4j.languages.Prism_markup;
import net.kilogram.messenger.prism4j.languages.Prism_python;
import net.kilogram.messenger.prism4j.languages.Prism_scala;
import net.kilogram.messenger.prism4j.languages.Prism_sql;
import net.kilogram.messenger.prism4j.languages.Prism_swift;
import net.kilogram.messenger.prism4j.languages.Prism_yaml;
