package net.kilogram.messenger.prism4j.languages;
...
public class Prism_clojure {
    ...
    public static Prism4j.Grammar create(@NonNull Prism4j prism4j) {
        return Prism4j.grammar("clojure",
                Prism4j.token("comment", Prism4j.pattern(compile(";+.*"))),
                Prism4j.token("string", Prism4j.pattern(compile("\"(?:\\\\.|[^\\\\\"\\r\\n])*\""))),
                Prism4j.token("operator", Prism4j.pattern(compile("(?:::|[:|'])\\b[a-z][\\w*+!?-]*\\b", CASE_INSENSITIVE))),
                ...
                Prism4j.token("boolean", Prism4j.pattern(compile("\\b(?:true|false|nil)\\b"))),
                Prism4j.token("number", Prism4j.pattern(compile("\\b[0-9A-Fa-f]+\\b"))),
