...
public class NekoChatSettingsActivity extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final AbstractConfigCell hidePremiumOnlyChannelRow = cellGroup.appendCell(new ConfigCellTextCheck(KiloConfig.INSTANCE.getHidePremiumOnlyChannel()));
...
//            }, null));
    ...
    private final AbstractConfigCell onlyShowBuiltInEmojiRow = cellGroup.appendCell(new ConfigCellTextCheck(KiloConfig.INSTANCE.getOnlyShowBuiltInEmoji()));
