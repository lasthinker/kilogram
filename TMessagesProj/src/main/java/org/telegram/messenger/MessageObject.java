        ...
        if (messageOwner instanceof TLRPC.TL_messageService) {
            ...
            if (!TextUtils.isEmpty(restrictionReason) && !NekoConfig.ignoreContentRestrictions.Bool()) {
                ...
                if (getMedia(messageOwner) instanceof TLRPC.TL_messageMediaDice) {
                    ...
                    messageText = LocaleController.getString("UnsupportedMedia", R.string.UnsupportedMedia).replace("https://telegram.org/update", "https://t.me/kilogram_messenger");
                ...
                if (attribute instanceof TLRPC.TL_documentAttributeAudio) {
                    if (attribute.voice) {
                        ...
                        try {
                            ...
                            String custom_api = KiloConfig.INSTANCE.getCustomArtworkApi().String();
