package net.kilogram.messenger.ui;

import static net.kilogram.messenger.utils.LangsKt.uDismiss;
import static net.kilogram.messenger.utils.LangsKt.uUpdate;
...
//                            ids.add(message.id);
    ...
    public MessageObject getLastMessageFromUnblock(long dialogId) {
        ...
        try {
            ...
            FileLog.e("Kilogram, ignoreBlocked, SQLiteException when read last message from unblocked user", sqLiteException);
            return null;
        }
        return ret;
    }
